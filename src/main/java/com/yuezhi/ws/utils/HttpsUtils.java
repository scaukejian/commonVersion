...
/**
 * Created by yanyuan on 16/10/17.
 */
public class HttpsUtils {
    ...
    public static void main(String[] args){
        String url = "https://192.168.1.44:8443/edate_ws/auth/createToken.do";
        Map<String, String> requestMap = new HashMap<>();
        requestMap.put("source", StaticFileUtil.getProperty("systemConfig", "ADMIN_SOURCE"));
        post(url, requestMap);

//        String url = "https://192.168.1.44:8443/edate_ws/privateLetter/batchAddIMMessage.do";
