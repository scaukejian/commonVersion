 window.onload=function(){
	 ...
	 if(isWeiXin()){
	        $(".footer").attr("href","http://a.app.qq.com/o/simple.jsp?pkgname=com.edate.appointment&g_f=991653")
	        $(".ios").attr("href","http://a.app.qq.com/o/simple.jsp?pkgname=com.edate.appointment&g_f=991653")
	        $(".and").attr("href","http://a.app.qq.com/o/simple.jsp?pkgname=com.edate.appointment")
	    }else{
	        $(".ios").attr("href","https://itunes.apple.com/cn/app/yi-yue-yue-hui/id1003136897?mt=8")
	        $(".and").attr("href","http://ws.edate.com.cn/app/Appointment.apk")
	    }
	    initSex();
	 //   initHeadFlag();
	...
	function initHeadFlag(){
		...
		if(userId == 'null' ||userId==undefined || userId == ''){
			$("#header").html("<img class='header' src='images/edate_logo.png'/>");
			$("#register").html("立即注册");
			return;
		}
		 //var  param={"userId":userId};
		var url = '/edate_ws/auth/getHeadFlag/'+userId+'.do';
		$.ajax({
	        type: 'GET',
	        url: url,
			success: function (result) {
				 ...
				 if(result.data != null){
					$("#header").html("<img class='header' src='/edate_ws/userDatum/download.do?fileName="+result.data.imgName+"'/>");
    ...
    function checkPlatform(){
        if(/android/i.test(navigator.userAgent)){
            $(".footer").attr("href","http://ws.edate.com.cn/app/Appointment.apk");//这是Android平台下浏览器
        }
...
//	            contentType: 'application/json',
	            ...
	            success: function (json) {
	              ...
	              $("#register-success").html("<img style='margin-top:20%;margin-bottom:48%;' src='images/register-success.jpg' width='100%'/>");
	          	  $("#app-download").html("<a href='http://a.app.qq.com/o/simple.jsp?pkgname=com.edate.appointment&g_f=991653'><img style='margin-left:10%;' src='images/app-download-btn.jpg' width='80%'/></a>")
	          	 },
	            error: function () {
	                alert('服务器繁忙，请稍后再试');
	                return;
